...
from mapping import events  # CHANGE
from Modules.display_object import DisplayObject

SHIP_COLOR = (0, 200, 0)  # The color we want the indicator circle to be
CIRCLE_SIZE = 5  # The size of the indicator circle we want


class Event(DisplayObject):  # CHANGE
    """
    ...
    def __init__(self, memory_reader, actor_id, address, my_coords, raw_name):
        ...
        self.name = events.get(self.raw_name).get("Name")  # CHANGE
