...
from mapping import other_events  # CHANGE
from Modules.display_object import DisplayObject

SHIP_COLOR = (255, 0, 213)  # The color we want the indicator circle to be
CIRCLE_SIZE = 5  # The size of the indicator circle we want


class Other(DisplayObject):  # CHANGE
    """
    ...
    def __init__(self, memory_reader, actor_id, address, my_coords, raw_name):
        ...
        self.name = other_events.get(self.raw_name).get("Name")  # CHANGE
